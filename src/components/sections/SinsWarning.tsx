...
const SinCard: React.FC<{ sin: SinEntry }> = ({ sin }) => {
  return (
    <Card className="shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-destructive rtl:border-r-4 rtl:border-l-0">
    ...
    <section id="sins-warning-section" className="py-8 scroll-mt-20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8 text-destructive relative pb-2
                       ...
                       after:w-20 after:h-1 after:bg-primary after:rounded-full">
